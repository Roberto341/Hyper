...
/**
 * @brief Divide vector_1 to vector_0 and returns a copy of the result.
 * 
 * @param vector_0 the first vector
 * @param vector_1 the second vector
 * @return The resulting vector
...
/**
 * @brief Returns the squard length of the provided vector.
 * 
 ...
 * @return A normalized copt of the supplied vector.
 */
...
/**
 * @brief Compares all elements of vector_0 and vector_1 and ensures the differnece
 ...
 * @param vector_0 The first vector.
 * @param vector_1 The second vector.
 * @return The distnace between vector_0 and vector_1.
 */
 ...
 * to calculate the differnece in direction.
 * 
 * @param vector_0 the first vector.
 * @param vector_1 the second vector.
...
/**
 * @brief Calculates and returns the corss product of the supplied vectors.
 * The cross product is a new vector which is orthoganal to both the provided vectors.
 * 
 * @param vector_0 the first vector.
 * @param vector_1 the second vector.
